...
class Detector(object):
    ...
    def __init__(self, net, weight_file):
        ...
        checkpoint_dir = '/home/syh/dl/dlfive/YOLO/yolo_tf/data/pascal_voc/output/2017_12_27_11_45'
    ...
    def image_detector(self, imname, wait=0):
        ...
        cv2.imwrite("test/pre_cat.jpg", image)
        # cv2.waitKey(wait)
...
def main():
    ...
    # weight_file='/home/syh/dl/dlfive/YOLO/yolo_tf/data/pascal_voc/output/2017_12_26_20_28'
    weight_file = tf.train.latest_checkpoint('/home/syh/dl/dlfive/YOLO/yolo_tf/data/pascal_voc/output/2017_12_26_20_28/')
